...
/// </remarks>
[SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "We only use C# and prefer syntax sugar.")]
    ...
    where TValue : notnull
{
    ...
    /// </example>
    [SuppressMessage("Design", "CA1002:Do not expose generic lists", Justification = "Implicit operators generally require concrete types in C#.")]
